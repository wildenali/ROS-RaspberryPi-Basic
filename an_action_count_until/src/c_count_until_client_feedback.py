...
class CountUntilClient:
	def __init__(self):
		self._ac = actionlib.SimpleActionClient('/count_until_feedback', CountUntilAsyncAction)
		self._ac.wait_for_server()
		rospy.loginfo("Action Server Feedback is up, we can send new goals!")
...
if __name__ == '__main__':
	rospy.init_node('count_until_client_feedback')
